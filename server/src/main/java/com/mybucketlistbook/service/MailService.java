...
//                "		<span style=\"font-size: 15px; margin: 0 0 10px 3px;\">My Bucket list Book</span><br />"																												+
                        ...
                        nickname + " ( " + email + " ) "																																																+
                        "		님 안녕하세요.<br />"																																													+
                        "		'나의 버킷리스트 북'에 가입해 주셔서 진심으로 감사드립니다.<br />"																																						+
        ...
        helper.setFrom("My Bucket list Book");
        helper.setTo(email);
        helper.setSubject("[My Bucket list Book - 회원가입 이메일 인증]");
