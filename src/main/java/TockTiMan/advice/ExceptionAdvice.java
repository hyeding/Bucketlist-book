...
public class ExceptionAdvice {
    ...
    public Response illegalArgumentExceptionAdvice(IllegalArgumentExcepion e) {
    ...
    // 400 에러
    // 요청 객체의 validation을 수행할 때, MethodrgumentNotValidException이 발생
    ...
    // 401 응답
    // 유저 정보가 일치하지 않음
    @ExceptionHandler(MemberNotEqualseException.class)
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    public Response memberNicknameAlreadyExistsException(MemberNicknameAlredayExistsException e) {
